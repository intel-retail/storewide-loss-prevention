...
> **Note:** Pre-built images are available on Docker Hub (`intel/poi-backend:2026.2.0-rc2`
> and `intel/poi-ui:2026.2.0-rc2`). The `docker-compose.yml` references them directly —
