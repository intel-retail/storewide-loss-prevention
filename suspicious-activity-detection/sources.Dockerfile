...
FROM intel/scene-understanding-service:latest AS source-builder
...
# This manifest tracks the Debian 12 package set aligned with the backend base image.
...
# -------- Final Stage --------
FROM intel/scene-understanding-service:latest AS final

LABEL description="Source redistribution image for GPL-licensed packages in intel/scene-understanding-service:latest"
...
# Copy the Debian 12 version manifest that matches the base image source lookup.
