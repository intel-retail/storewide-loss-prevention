...
# YOLO_MODEL_NAME / RTMPOSE_MODEL_NAME / VLM_ENABLED there; init.sh propagates
...
AI_KEYS_REGEX='^(VLM_ENABLED|VLM_MODEL_NAME|VLM_PRECISION|TARGET_DEVICE|YOLO_MODEL_NAME|RTMPOSE_MODEL_NAME|SCENESCAPE_VERSION|SCENESCAPE_REGISTRY|DLSTREAMER_VERSION)='
